"""Repository package — re-exports all concrete repositories.

The ``repositories/`` directory package takes precedence over the sibling
``repositories.py`` module in Python's import resolution.  All existing
``from devhub.adapters.persistence.repositories import ThreadRepository``
imports continue to work via this re-export.
"""
